...
<form method="post">
    <table>
        <tr>
            ...
            <td><input type="number" name="canh1" value="<?php echo $num1 ?>"></td>
        </tr>
        <tr>
            <td> Nhap canh thu hai:</td>
            <td><input type="number" name="canh2" value="<?php echo $num2 ?>"></td>
        </tr>
        <tr>
            <td> Nhap canh thu ba:</td>
            <td><input type="number" name="canh3" value="<?php echo $num3 ?>"></td>
